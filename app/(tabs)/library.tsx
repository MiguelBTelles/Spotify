    ...
    <Container>
      ...
      <Content>
        ...
        <View style={{
          ...
          <AvatarArtists onPress={()=> {router.push('/artist-perfil')}} title={'2ZDinizz'} artist={'Artista'} image={'https://images.unsplash.com/photo-1732572854523-f330af9a72ee?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwyM3x8fGVufDB8fHx8fA%3D%3D'}/>
